...
class CrossEntropyCostTests(unittest.TestCase):
    def test_single_example_1_output_neuron_no_entropy(self):
        a = [np.array([0], float)]
        y = [np.array([0], float)]
        c = cost_functions.cross_entropy(activations=a, outputs=y)
    ...
    def test_single_example_1_output_neuron_entropy_increases(self):
        ...
        y = [np.array([0], float)]
        c1 = cost_functions.cross_entropy(activations=a, outputs=y)

        a = [np.array([0.3], float)]
        y = [np.array([0], float)]
        c2 = cost_functions.cross_entropy(activations=a, outputs=y)
